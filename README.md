...
This repository contains a simple photo gallery website. The website is made using HTML, CSS, and JavaScript.It has four pages: Home, Gallery, About Us, and Contact Us. The design is clean and easy to use on mobile and laptop screens.
